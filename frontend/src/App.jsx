      ...
      {uiMode === "simple" ? (
        <div className="simple-mode-grid" style={{ display: "grid", gap: 18, marginBottom: 18 }}>
          <div className="simple-builder-grid">
            <Panel
              title="Simple Builder Clean"
              subtitle="One command, one guided workspace, no floating steps."
              collapsible={false}
            >
              <div className="builder-form" style={{ gap: 14 }}>
                <div className="module-top">
                  <strong>Guided command bar</strong>
                  <span className="tag">Simple Clean</span>
                </div>
            ...
            <Panel
              title="Live Preview"
              subtitle="Simple mode stays clean and stable."
              collapsible={false}
            >
              <PreviewCanvas
                layout={layoutState}
            ...
            >
              <div className="command-row">
                <button className="mini-btn" onClick={runBatteryPlan} disabled={isLoading}>
                  {isLoading ? "Running planner..." : "Run planner"}
                </button>
                <button className="mini-btn" onClick={saveCurrentResult}>
                  Save result
                </button>
                <button className="mini-btn" onClick={exportReport}>
                  Export report
                </button>
              </div>
              <div className="status-grid" style={{ marginTop: 14 }}>
